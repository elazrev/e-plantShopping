...
function ProductList({ onHomeClick }) {
    ...
    // All plants as a flat array with category
    const plantsArray = [
        {
    ...
    // Flatten all plants with category
    const allPlants = plantsArray.flatMap(cat => cat.plants.map(plant => ({ ...plant, category: cat.category })));
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    <div>
                      <a href="#" onClick={(e) => handleBackToPlants(e)} style={styleA}>
                        <span className="plant-icon" aria-label="plant">
                          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 21C12 21 4 13.5 4 8.5C4 5.46243 6.46243 3 9.5 3C11.1569 3 12.5 4.34315 12.5 6C12.5 4.34315 13.8431 3 15.5 3C18.5376 3 21 5.46243 21 8.5C21 13.5 12 21 12 21Z" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                          </svg>
                        </span>
                        Plants
                      </a>
                    ...
                    <div> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                {getCartItemCount() > 0 && (
                                    <span className="cart_quantity_count">{getCartItemCount()}</span>
                                )}
                            </h1>
                        </a>
                    </div>
